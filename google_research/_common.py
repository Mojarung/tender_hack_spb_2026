"""Shared helpers for the Google Shopping research scripts.

Mirror of runet_research/_common.py."""
...
PROFILE_DIR = Path(__file__).parent / ".profile_google"
...
def query_from_argv(default: str = "iphone 15 купить") -> str:
    if len(sys.argv) > 1:
...
__all__ = [
    ...
    "save_json", "Timer", "query_from_argv",
]
