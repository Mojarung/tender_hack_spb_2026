/** Mock product offers — used as an instant placeholder before the
 *  backend search call resolves (or as a permanent fallback when it
 *  errors out). Lets the design read correctly without waiting on
 *  Ozon/YM to bypass anti-bot.
 */
...
export const MOCK_OFFERS: ProductOffer[] = [
  {
    source: "wb",
    name: "Apple iPhone 15 128 GB, Чёрный",
    price: "53196",
    currency: "RUB",
  ...
  {
    source: "ya_market",
    name: "Apple iPhone 15 128 ГБ, чёрный",
    price: "55490",
    currency: "RUB",
    url: "https://market.yandex.ru/product--apple-iphone-15-128gb/",
    image: "https://avatars.mds.yandex.net/i?id=iphone15-128.jpg",
  ...
  {
    source: "runet",
    name: "iPhone 15 128GB (ростест)",
    price: "52900",
    currency: "RUB",
    url: "https://re-store.ru/iphone-15-128-black/",
    image: null,
  ...
  {
    source: "ozon",
    name: "Робот-пылесос Xiaomi Robot Vacuum X20+",
    price: "29990",
    currency: "RUB",
    url: "https://www.ozon.ru/product/xiaomi-vacuum-x20/",
    image: "https://ir.ozone.ru/s3/multimedia-d/c1000/xiaomi-vacuum-x20.jpg",
  ...
  },
  {
    ...
    price: "32500",
    currency: "RUB",
    url: "https://market.yandex.ru/product--sony-wh-1000xm5/",
    image: "https://avatars.mds.yandex.net/i?id=sony-wh1000xm5.jpg",
  ...
  {
    source: "runet",
    name: "Sony WH-1000XM5 (новый)",
    price: "31290",
    currency: "RUB",
    url: "https://citilink.ru/sony-wh-1000xm5/",
    image: null,
...
export const MOCK_TOP_DEALS: RankedOffer[] = MOCK_OFFERS.slice(0, 4).map((offer, i) => ({
  offer,
  score: Number((1 - i * 0.18).toFixed(3)),
  rank: i + 1,
}));
