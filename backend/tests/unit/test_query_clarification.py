...
async def test_query_clarification_ambiguous_success(mock_client_class) -> None:
    ...
    mock_chat_res = {
        "message": {
            "content": '{"is_ambiguous": true, "reason": "Запрос содержит разные категории товаров", "options": [{"label": "Смартфоны", "text": "Искать iPhone", "query": "iphone"}, {"label": "Авто", "text": "Искать Tiggo", "query": "tiggo"}]}'
        }
    }
